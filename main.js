...
var personName = "wajiha khan";
var name_Splited = personName.split(" ");
console.log(name_Splited);
for (var i = 0; i < name_Splited.length; i++) {
    var word = name_Splited[i];
    name_Splited[i] = word.charAt(0).toUpperCase() + word.slice(1).toLowerCase();
}
var join_method = name_Splited.join(" ");
console.log(name_Splited);
